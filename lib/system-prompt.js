 ...
 * v3.0 — 结构化分离控制策略
 * 基于 2026-03-29 多轮 A/B 测试验证的最优策略
 */
...
- "Do not change the camera angle"（单独使用效果差）
...
- "Do not raise, lower, or rotate the camera"（配合具体参数使用）
...
- "Low saturation, mir style"

✅ 应该这样写（关系描述，基于参考图实际观察）：
- "The main campus buildings are distinctly brighter than their surroundings — rooftops catch ambient daylight"
- "Building facades facing the sun are warmly lit, while shadow sides show natural cool tones"
- "The surrounding urban context appears darker and more muted compared to the campus"
...
3. 参考图分析要具体——描述你从参考图中实际看到的光线、色彩、氛围特征，不要泛泛地说"学习其风格"
